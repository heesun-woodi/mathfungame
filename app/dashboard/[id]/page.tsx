...
import type { PlayerStats, Attempt } from "@/db/schema";
...
const DailyChart = dynamic(() => import("@/components/charts/DailyChart"), { ssr: false });
const CumulativeChart = dynamic(() => import("@/components/charts/CumulativeChart"), { ssr: false });
const LevelChart = dynamic(() => import("@/components/charts/LevelChart"), { ssr: false });
  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="flex items-center justify-between gap-3 p-3 border-b bg-card/50">
        ...
        <h1 className="font-bold text-lg">학습 현황</h1>
        <Button
          variant="ghost"
          size="icon"
          onClick={() => router.push(`/game/${playerId}`)}
      ...
      <div className="max-w-lg mx-auto p-4 space-y-4">
        ...
        >
          <Card>
            ...
            <CardContent className="pb-5">
              <CumulativeChart playerId={playerId} />
            </CardContent>
          </Card>
        </motion.div>
              ...
              {wrongLoading ? (
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    className="w-full"
                    variant="outline"
                    onClick={() => router.push(`/review/${playerId}`)}
                  >
