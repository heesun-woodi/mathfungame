import type { MathProblem, OperatorType } from "@shared/schema";
...
const LEVEL_CONFIGS: Record<number, LevelConfig> = {
  1: {
    ...
    maxNumber: 10,
    minNumber: 1,
    description: "10 이하 덧셈",
  },
  2: {
    operators: ["+", "-"],
    maxNumber: 10,
    minNumber: 1,
    description: "10 이하 덧셈과 뺄셈",
  },
  3: {
    operators: ["+", "-"],
    maxNumber: 20,
    minNumber: 1,
    description: "20 이하 덧셈과 뺄셈",
  },
  4: {
    operators: ["+", "-", "×"],
    maxNumber: 20,
    minNumber: 1,
    description: "20 이하 덧셈, 뺄셈, 구구단(2~5단)",
  },
  5: {
    operators: ["+", "-", "×"],
    maxNumber: 50,
    minNumber: 1,
    description: "50 이하 덧셈, 뺄셈, 구구단(2~9단)",
  },
  6: {
    operators: ["+", "-", "×", "÷"],
    maxNumber: 50,
    minNumber: 1,
    description: "50 이하 사칙연산",
  },
  7: {
    operators: ["+", "-", "×", "÷"],
    maxNumber: 100,
    minNumber: 1,
    description: "100 이하 사칙연산",
  },
  8: {
    operators: ["+", "-", "×", "÷"],
    maxNumber: 200,
    minNumber: 10,
    description: "200 이하 사칙연산",
  },
  9: {
    operators: ["+", "-", "×", "÷"],
    maxNumber: 500,
    minNumber: 10,
    description: "500 이하 사칙연산",
  },
  10: {
    operators: ["+", "-", "×", "÷"],
    maxNumber: 1000,
    minNumber: 10,
    description: "1000 이하 사칙연산",
  },
};
...
export function getOperatorEmoji(op: OperatorType): string {
  switch (op) {
    case "+": return "plus";
    case "-": return "minus";
