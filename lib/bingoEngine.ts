...
/**
 * 동물 이미지 URL 생성
 * Using Lorem Picsum for reliable image loading
 * TODO: Replace with actual animal photos later
 */
export function getAnimalImageUrl(animal: Animal): string {
  // Use Lorem Picsum with animal name as seed for consistent images per animal
